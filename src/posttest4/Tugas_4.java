...
new Timer(1000, taskPerformer).start();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DEVAN EXPRESS UNION");
        ...
        diskon.setBackground(new java.awt.Color(255, 255, 153));
        ...
        regular.setBackground(new java.awt.Color(153, 255, 204));
        buttonGroup1.add(regular);
        regular.setText("Regular");

        express.setBackground(new java.awt.Color(153, 255, 204));
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                        .addComponent(atur, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                        .addContainerGap())))
        );
    ...
    private void namaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_namaCaretUpdate
        // TODO add your handling code here:
        if(nama.getText().length() !=0 && no.getText().length() !=0){
    ...
    private void noCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_noCaretUpdate
        // TODO add your handling code here:
        if(no.getText().length() !=0 && nama.getText().length() !=0){
            proses.setEnabled(true);
        }
        else{
            proses.setEnabled(false);
